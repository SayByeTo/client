...
(function(){
  ...
  angular.module("myApp").service("totService", function($translate, commonService, TOT_CONSTANT){
    return {
      // 首字母大写
      ...
      find: function(key, options, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["find"+ this.toUpper(key)],
          method: "GET",
      ...
      create: function(key, data, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["create"+ this.toUpper(key)],
          method: "POST",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      read: function(key, id, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["read"+ this.toUpper(key)].replace("#id#", id),
          method: "GET",
          success: function(datas){
            cb && cb(datas.data);
          }
      ...
      update: function(key, data, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["update"+ this.toUpper(key)],
          method: "PUT",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      deleteOne: function(key, id, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["delete"+ this.toUpper(key)].replace("#id#", id),
          method: "DELETE",
          success: function(datas){
            cb && cb(datas.data);
          }
      ...
      deleteMore: function(key, ids, cb){
        commonService.ajaxMushiny({
          url: TOT_CONSTANT["delete"+ this.toUpper(key)],
          method: "DELETE",
          data: {
            ids: ids
          },
