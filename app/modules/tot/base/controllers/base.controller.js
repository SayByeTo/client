...
(function () {
  ...
  angular.module('myApp').controller("totCtl", function ($rootScope, $scope, $state, $translate, $window, commonService, TOT_FILTER, totService) {
    // ======================================================================================================================
    ...
    $rootScope.selectInWindow = function(options){
      ...
      commonService.dialogMushiny($scope.window, {
        ...
        open: function(){
          ...
          $rootScope.queryGridOptions = commonService.gridMushiny({columns: options.srcColumns, dataSource: totService.getGridDataSource(options.srcKey), height: height-147});
