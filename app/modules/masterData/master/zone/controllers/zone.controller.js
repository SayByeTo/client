...
(function () {
  ...
  angular.module('myApp').controller("zoneCtl", function ($scope, $window, $state, commonService, masterService) {

    $window.localStorage["currentItem"] = "zone";
    
    var columns = [
      {field: "name", template: "<a ui-sref='main.zoneRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
      {field: "description", headerTemplate: "<span translate='DESCRIPTION'></span>"}
     ];
    $scope.zoneGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("zone")});
