...
(function () {
  ...
  angular.module('myApp').controller("packingStationTypeCtl", function ($scope, $rootScope, $translate, $window, $state, commonService, masterService) {
    ...
    var columns = [
      {field: "name", template: "<a ui-sref='main.packingStationTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
    ...
    $scope.packingStationTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("packingStationType")});
    ...
    $scope.ifScan = "false"; $scope.ifPrint = "false";
    $scope.ifScanInvoice = "false"; $scope.ifWeight = "false";
