...
(function () {
  ...
  angular.module('myApp').controller("rebatchStationTypeCtl", function ($scope, $rootScope, $translate, $window, commonService, masterService) {
    ...
    var columns = [
      {field: "name", template: "<a ui-sref='main.rebatchStationTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
      {field: "description", headerTemplate: "<span translate='DESCRIPTION'></span>"}
    ];
    $scope.rebatchStationTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("rebatchStationType")});
