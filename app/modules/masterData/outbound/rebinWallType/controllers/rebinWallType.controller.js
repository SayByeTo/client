...
(function () {
  ...
  angular.module('myApp').controller("rebinWallTypeCtl", function ($scope, $rootScope, $window, $state, commonService, masterService) {
    ...
    var columns = [
      {field: "name", template: "<a ui-sref='main.rebinWallTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
    ...
    $scope.rebinWallTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("rebinWallType")});
