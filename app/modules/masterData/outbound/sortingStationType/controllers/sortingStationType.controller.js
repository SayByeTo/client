...
(function () {
  ...
  angular.module('myApp').controller("sortingStationTypeCtl", function ($scope, $rootScope, $translate, $window, commonService, masterService) {
    ...
    var columns = [
      {field: "name", template: "<a ui-sref='main.sortingStationTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
      {field: "description", headerTemplate: "<span translate='DESCRIPTION'></span>"}
    ];
    $scope.sortingStationTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("sortingStationType")});
