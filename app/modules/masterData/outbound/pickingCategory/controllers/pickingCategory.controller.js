...
(function () {
  ...
  angular.module('myApp').controller("pickingCategoryCtl", function ($scope, $rootScope, $window, $state, $translate, commonService, masterService, pickingCategoryService) {
    ...
    $rootScope.pickingCategoryRuleSource = masterService.getDataSource({key: "getPickingCategoryRule", text: "name", value: "id"});
    ...
    $scope.pickingCategoryPositionGridOptions = masterService.editGrid({
      ...
      columns: [
        ...
        {field: "operator", width: 200, headerTemplate: "<span translate='OPERATOR'></span>", editor: function(container, options){
          masterService.selectEditor(container, options, options.model.rule.operators);
        }},
        {field: "value", headerTemplate: "<span translate='VALUE'></span>", editor: function(container, options){
