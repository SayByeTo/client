...
(function () {
  ...
  angular.module('myApp').controller("processPathTypeCtl", function ($scope, $window, $state, commonService, masterService) {

    $window.localStorage["currentItem"] = "processPathType";

    var columns = [
      {field: "name", template: "<a ui-sref='main.processPathTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
      {field: "description", headerTemplate: "<span translate='DESCRIPTION'></span>"}
    ];
    $scope.processPathTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: masterService.getGridDataSource("processPathType")});
