...
(function () {
    ...
    angular.module('myApp').controller("processPathCtl", function ($scope, $rootScope, $window, commonService, masterService) {
        ...
        $scope.scanBinFirst = "false";
        $scope.colorBasedBinPicking = "false";
        $scope.colorBasedItemPicking = "false";
        $scope.oneItemPerTote = "false";
        $scope.requireNewToteOnPickAreaChange = "false";
