...
(function(){
  ...
  angular.module("myApp").service("outboundService", function($translate, commonService,OUTBOUND_CONSTANT){
    return {
        // 首字母大写
      ...
      return {
        ...
        return {
            ...
            filter: OUTBOUND_CONSTANT["find"+ key].indexOf("wms")>=0? {}: {field: "entityLock", operator: "eq", value: "0"},
            schema: {
