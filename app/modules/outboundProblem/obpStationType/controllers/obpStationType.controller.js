...
(function () {
  ...
  angular.module('myApp').controller("obpStationTypeCtl", function ($scope, $rootScope, $window, $translate, $state, commonService, problemOutboundBaseService) {
    ...
    var columns = [
      {field: "name", template: "<a ui-sref='main.obpStationTypeRead({id:dataItem.id})'>#: name # </a>", headerTemplate: "<span translate='NAME'></span>"},
      {field: "description", headerTemplate: "<span translate='DESCRIPTION'></span>"}
    ];
    $scope.obpStationTypeGridOptions = commonService.gridMushiny({columns: columns, dataSource: problemOutboundBaseService.getGridDataSource("obpStationType")});
    ...
    var stationTypePositionColumns = [
      {field: "positionIndex", editor: problemOutboundBaseService.numberEditor, headerTemplate: "<span translate='POSITION_INDEX'></span>"},
