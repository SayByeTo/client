...
(function(){
  ...
  angular.module("myApp").service("problemOutboundBaseService", function($translate, commonService, PROBLEM_OUTBOUND){
    return {
      // 首字母大写
      ...
      find: function(key, options, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_OUTBOUND["find"+ this.toUpper(key)],
          method: "GET",
      ...
      create: function(key, data, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_OUTBOUND["create"+ this.toUpper(key)],
          method: "POST",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      read: function(key, id, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_OUTBOUND["read"+ this.toUpper(key)].replace("#id#", id),
          method: "GET",
          success: function(datas){
            cb && cb(datas.data);
          }
      ...
      update: function(key, data, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_OUTBOUND["update"+ this.toUpper(key)],
          method: "PUT",
          data: data,
          success: function(datas){
            cb && cb(datas.data);
      ...
      deleteOne: function(key, id, cb){
        commonService.ajaxMushiny({
          url: PROBLEM_OUTBOUND["delete"+ this.toUpper(key)].replace("#id#", id),
          method: "DELETE",
          success: function(datas){
            cb && cb(datas.data);
          }
