...
(function(){
  ...
  angular.module("myApp")
    ...
    .controller("mainCtl", function($scope, $state, $window, $translate, mainService, myProvider){
      ...
      var inbound = ["receiving", "receivingContainer", "stow", "inbound_problem_disposal", "inbound_problem_manage"];
      var outbound = ["pickToPack", "pickToTote", "rebatch", "pick", "pack", "re_bin", "rebin_pack"];
      ...
      var tool = ["input_validity_query", "measure_query"];
      var report = ["fud", "workflow", "pick_query", "capacity","capacity_side","capacity_bin"];
      var items = inbound.concat(outbound, outboundProblem, shipment, tool, report), targetName = name.replace("main.", "");
