...
(function () {
  ...
  angular.module('myApp').controller("fudCtl", function ($scope, $window, commonService, fudService,reportService) {
    ...
    //
    var legacyColumns = [
      {field: "skuNo", width: 150, headerTemplate: "<span translate='SKU_NO'></span>"},
      {field: "skuId", width: 150, headerTemplate: "<span translate='SKU_ID'></span>"},
      {field: "clientName", width: 100, headerTemplate: "<span translate='CLIENT'></span>"},
      {field: "state", width: 60, headerTemplate: "<span translate='STATE'></span>"},
      {field: "amount", width: 60, headerTemplate: "<span translate='COUNT'></span>"},
      {field: "containerName", width: 100, headerTemplate: "<span translate='容器号码'></span>"},
      {field: "activityCode", width: 100, headerTemplate: "<span translate='容器最后操作'></span>"},
      {
        field: "modifiedDate",
        width: 130,
      ...
      {field: "totalTime", width: 100, headerTemplate: "<span translate='累计时长(日)'></span>"},
      {field: "skuName", width: 250, headerTemplate: "<span translate='ITEM_DATA_NAME'></span>"}
    ];
    ...
    var fudColumns = [
      ...
      {field: "totalTime", width: 100, headerTemplate: "<span translate='累计时长(日)'></span>"},
      {field: "overTime", width: 120, headerTemplate: "<span translate='影响客户订单时长'></span>"},
      {field: "skuname", width: 250, headerTemplate: "<span translate='ITEM_DATA_NAME'></span>"}
    ];
