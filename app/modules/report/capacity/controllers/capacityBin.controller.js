...
(function () {
  ...
  angular.module('myApp').controller("capacityBinCtl", function ($scope, $stateParams, $rootScope, $window, $state, commonService, reportService, capacityService) {
    ///////////////////////////////////////////capacityBin

    $window.localStorage["currentItem"] = "capacityBin";
    var columns = [{
    ...
    //$scope.capacityBin_ExSDSource = ["2017-03-18 01:00:00", "2017-03-18 02:00:00", "2017-3-18 3:00", "2017-3-18 4:00", "2017-3-18 5:00", "2017-3-18 6:00", "2017-3-18 7:00", "2017-3-18 8:00", "2017-3-18 9:00", "2017-3-18 10:00", "2017-3-18 11:00", "2017-3-18 12:00", "2017-3-18 13:00", "2017-3-18 14:00", "2017-3-18 15:00", "2017-3-18 16:00", "2017-3-18 17:00", "2017-3-18 18:00", "2017-3-18 19:00", "2017-3-18 20:00", "2017-3-18 21:00", "2017-3-18 22:00", "2017-3-18 23:00"]

    capacityService.queryCapacityBin($stateParams.id,function (data) {

      var capacityBinOpt = reportService.editGrid({
        dataSource: data,
        columns: columns,
        editable: false,
        height: $(document.body).height() - $("#capacityBinbar").height() - 130,
      });
      $scope.capacityBinGridOptions = capacityBinOpt;
    });
    ///<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  });
})();