...
(function () {
  ...
  angular
    .module("myApp")
    .controller("workflowCtl", function (
      $scope,
      $timeout,
      $rootScope,
      $stateParams,
      ...
      $scope.doLocation = function () {
        ...
        if ($scope.exsdType == "ALL") {} else if ($scope.exsdType == "Today") {} else if ($scope.exsdType == "Next 3 Days") {
        ...
        } else if (dimensionY === "None" && dimensionX === "WorkPool") {
          //  $state.go("main.workflowWorkPoolProcessPath");
          refresh();
        }
      };
      ...
      $scope.workflowGridOptions = {
        height: $(document.body).height() - 148,
        selectable: false,
        sortable: false,
        resizable: true
      };
    ...
    .controller("workflowDetailCtl", function (
      $scope,
      $rootScope,
      $window,
      $stateParams,
      ...
      workflowService.getWorkflowDetail($stateParams.id, workflowType, function (
        datas
      ) {
